...
y = 5
z = x + y
print("Output #2: Four plus five equlas {0:d}.".format(z))
...
print("Output #19: {0:s} {1:s} {2:s}".format("Shie is", "very " * 4, "beautiful."))
m = len(sentence)
...
# reomove() 함수를 이용하여 리스트 내 특정 원소를 제거하기
...
print("Output #92: {}".format(my_lists_sorted_by_index3_and_0))
...
if 'y' in another_dict:
    print("Output #114: y is a key in anoter_dict: {}".format(another_dict.keys()))
if 'c' not in another_dict:
    print("Output #115: c is not a key in anoter_dict: {}".format(another_dict.keys()))
...
# if-elif-else 문
if x > 6:
    print("Output #125: x is greather than six")
elif x > 4 and x == 5:
    print("Output #125: {}".format(x*x))
else:
    print("Output #125: x is not greather than 4")

y = ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']
z = ['Annie','Betty','Claire','Daphne','Ellie','Franchesca','Greta','Holly','Iszbel','Jenny']
